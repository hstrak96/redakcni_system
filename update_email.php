...
$sql = "UPDATE login_redaktor SET email='$_GET[email]' WHERE login='$_SESSION[Username]'";

/*$sql = "UPDATE login_redaktor SET icon='$val3' WHERE login='$_SESSION[Username]'";
*/
...
<?php
 ...
 if (mysqli_query($spojeni, $sql)) {
    echo "Váš e-mail byl úspešně změněn, pro viditelnost změny se odhlašte a znovu přihlašte.";
} else {
