...
<td rowspan="2" height="130px" width="50%"><div class='redakce_pozadi'>
 <?php
 $sql = "select * from Rezervace Where ID_But = 41";
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="41" id="star41" required>
        <label for="star41">
...
<td height="130px"><div class='redakce_pozadi'>       
        <?php
 $sql = "select * from Rezervace Where ID_But = 42";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="42" id="star42">
        <label for="star42">
        <img class="obryz" src="free.png">
        </label>
');
...
<td height="130px"><div class='redakce_pozadi'>
<?php
 $sql = "select * from Rezervace Where ID_But = 43";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="43" id="star43">
        <label for="star43">
        <img class="obryz" src="free.png">
        </label>
');
...
<td rowspan="3" height="130px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 44";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="44" id="star44">
        <label for="star44">
        <img class="obryz" src="free.png">
        </label> 
');
...
<td height="130px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 45";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="45" id="star45">
        <label for="star45">
        <img class="obryz" src="free.png">
        </label> 
');
...
<td height="150px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 46";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="46" id="star46">
        <label for="star46">
        <img class="obryz" src="free.png">
        </label> 
');
...
<td height="150px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 47";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="47" id="star47">
        <label for="star47">
        <img class="obryz" src="free.png">
        </label>
');
...
<td colspan="2" height="150px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 48";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="48" id="star48">
        <label for="star48">
        <img src="free.png">
        </label>
');
