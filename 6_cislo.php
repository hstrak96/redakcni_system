...
<td rowspan="2" height="130px" width="50%"><div class='redakce_pozadi'>
 <?php
 $sql = "select * from Rezervace Where ID_But = 51";
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="51" id="star51" required>
        <label for="star51">
...
<td height="130px"><div class='redakce_pozadi'>       
        <?php
 $sql = "select * from Rezervace Where ID_But = 52";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="52" id="star52">
        <label for="star52">
        <img class="obryz" src="free.png">
        </label>
');
...
<td height="130px"><div class='redakce_pozadi'>
<?php
 $sql = "select * from Rezervace Where ID_But = 53";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="53" id="star53">
        <label for="star53">
        <img class="obryz" src="free.png">
        </label>
');
...
<td rowspan="3" height="130px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 54";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="54" id="star54">
        <label for="star54">
        <img class="obryz" src="free.png">
        </label> 
');
...
<td height="130px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 55";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="55" id="star55">
        <label for="star55">
        <img class="obryz" src="free.png">
        </label> 
');
...
<td height="150px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 56";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="56" id="star56">
        <label for="star56">
        <img class="obryz" src="free.png">
        </label> 
');
...
<td height="150px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 57";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="57" id="star57">
        <label for="star57">
        <img class="obryz" src="free.png">
        </label>
');
...
<td colspan="2" height="150px"><div class='redakce_pozadi'>
        <?php
 $sql = "select * from Rezervace Where ID_But = 58";
 $vysledek = mysqli_query($spojeni, $sql);
 $radek = mysqli_fetch_assoc($vysledek);
 $mez =  $radek['But_stat'];$mez2 =  $radek['INT_Stav'];
...
if ($mez == 0) 
echo('
        <input class="hid" type="radio" name="star" value="58" id="star58">
        <label for="star58">
        <img src="free.png">
        </label>
');
