...
$sql = "UPDATE login_redaktor SET login='$_GET[user]' WHERE login='$_SESSION[Username]'";
?>
...
<?php
 ...
 if (mysqli_query($spojeni, $sql)) {
    echo "Váš login byl úspešně změněn, pro viditelnost změny se odhlašte a znovu přihlašte.";
} else {
